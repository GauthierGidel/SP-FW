...
legendFontSize] = ...
    ...
    'markerSize',16,'markers',[],'markerSpacing',[],...
    'xlimits',[],'ylimits',[],...
    'logScale',0,'legendLoc','Best','useLines',1,'fillFace',1,...
    'errors',[],'errorStyle',{'--'},'errorColors',[],'errorFill',0,'labelLines',0,'labelLoc',2,'labelRotate',1,'legendFontSize',12);
...
set(gca,'FontName','AvantGarde','FontWeight','normal','FontSize',16);

if ~isempty(plotTitle)
    hTitle = title(plotTitle);
    set(hTitle,'FontName','AvantGarde','FontSize',16,'FontWeight','bold');
end

if ~isempty(plotXlabel) || ~isempty(plotYlabel)
    h1 = xlabel(plotXlabel);
    h2 = ylabel(plotYlabel);
    set([h1 h2],'FontName','AvantGarde','FontSize',16,'FontWeight','normal','interpreter','LaTex');
end
